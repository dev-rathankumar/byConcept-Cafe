<?php
if ( ! class_exists( 'myCRED_Rest_API_License' ) ) :
	final class myCRED_Rest_API_License {

		// Plugin Version
		public $version = MYCRED_RESET_API_VERSION;

		// Plugin Slug
		public $slug    = MYCRED_RESET_API_SLUG;

		public $base    = MYCRED_RESET_API_THIS;
...
function mycred_rest_api_license() {
	return myCRED_Rest_API_License::instance();
}
mycred_rest_api_license();