...
class DUPX_WPEngine_Host implements DUPX_Host_interface
{
    ...
    {
        $fdPlugins = DUPX_Paramas_Manager::getInstance()->getValue(DUPX_Paramas_Manager::PARAM_FORCE_DIABLE_PLUGINS);
        ...
        DUPX_Paramas_Manager::getInstance()->setValue(DUPX_Paramas_Manager::PARAM_FORCE_DIABLE_PLUGINS, $fdPlugins);
    }
}