	...
	private function set_composited_cart_item( $cart_item, $composite ) {
		...
		if ( $cart_item[ 'data' ]->needs_shipping() ) {
			...
			if ( $component_option && false === $component_option->is_shipped_individually() ) {
				 ...
				 */
				if ( apply_filters( 'woocommerce_composited_product_has_bundled_weight', $composite->get_aggregate_weight(), $cart_item[ 'data' ], $component_id, $composite ) ) {
				...
				$cart_item[ 'data' ]->composited_value = $cart_item[ 'data' ]->get_price( 'edit' );
