...
class WC_CP_PB_Compatibility {
	...
	public static function init() {
		...
		if ( is_callable( array( 'WC_PB_Product_Prices', 'get_bundled_cart_item_discount_method' ) ) && 'filters' === WC_PB_Product_Prices::get_bundled_cart_item_discount_method() ) {
			add_filter( 'woocommerce_bundled_cart_item', array( __CLASS__, 'bundled_cart_item_discount' ) );
		}
	 ...
	 * Create component reference to aggregate discount of component into bundled item - 'filters' method implementation.
	 *
	 * @see WC_CP_Products::filter_bundled_item_discount_cart
	 *
	 * @param  string  $cart_item
	 * @return void
	 */
	public static function bundled_cart_item_discount( $cart_item ) {
