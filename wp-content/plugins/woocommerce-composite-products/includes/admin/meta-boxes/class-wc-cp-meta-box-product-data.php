...
class WC_CP_Meta_Box_Product_Data {
	...
	public static function init() {
		...
		add_action( 'woocommerce_product_options_shipping', array( __CLASS__, 'shipping_type_admin_html' ), -100 );
		...
		add_action( 'woocommerce_composite_component_admin_advanced_html', array( __CLASS__, 'component_id_marker' ), 30, 3 );
					...
					if ( ! empty( $composite_data ) ) {
						...
						<div class="bto_boarding__components">
							<div class="bto_boarding__components__message">
								...
								<p><?php _e( 'Components are the <a href="https://docs.woocommerce.com/document/composite-products/composite-products-configuration/" target="_blank">building blocks</a> of every Composite Product.', 'woocommerce-composite-products' ); ?>
	...
	public static function shipping_type_admin_html() {
		...
		<div class="options_group composite_type show_if_composite">
			...
			<div id="message" class="inline notice">
				<p>
					<span class="assembled_notice_title"><?php _e( 'Where did the shipping options go?', 'woocommerce-composite-products' ); ?></span><br/>
					<?php _e( 'The contents of this composite product preserve their dimensions, weight and shipping classes. Unassembled composite products do not have a physical container. The parent item that groups components in the cart is virtual &ndash; it has no shipping properties of its own.', 'woocommerce-composite-products' ); ?>
				</p>
			</div>
		<?php
				...
				<div id="bto_scenarios_inner"><?php
					...
					if ( ! empty( $composite_data ) ) {
							...
							if ( ! empty( $scenarios_data ) ) {
								...
								?><div class="bto_boarding__scenarios bto_scenarios__boarding--scenarios_empty">
									<div class="bto_boarding__scenarios__message">
										...
										<br/><?php _e( 'Need assistance? <a href="https://docs.woocommerce.com/document/composite-products/composite-products-advanced-configuration/" target="_blank">Check out the documentation</a>, or <a href="https://woocommerce.com/my-account/marketplace-ticket-form/" target="_blank">get in touch with us</a>.', 'woocommerce-composite-products' ); ?>
										</p>
									</div>
								</div><?php
							}
						...
						?><div class="bto_boarding__scenarios bto_scenarios__boarding--components_empty">
							<div class="bto_boarding__scenarios__message">
								<h3><?php _e( 'Scenarios', 'woocommerce-composite-products' ); ?></h3>
								<p><?php _e( 'First, <a href="https://docs.woocommerce.com/document/composite-products/composite-products-configuration/" target="_blank">create some Components</a> by navigating to the Components tab.', 'woocommerce-composite-products' ); ?>
								<br/><?php _e( 'Then, return here to <a href="https://docs.woocommerce.com/document/composite-products/composite-products-advanced-configuration/" target="_blank">define Scenarios</a>.', 'woocommerce-composite-products' ); ?>
								</p>
							</div>
						</div><?php
					}
