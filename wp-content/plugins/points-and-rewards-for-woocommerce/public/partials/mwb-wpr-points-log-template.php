...
if ( isset( $user_id ) && null != $user_id && is_numeric( $user_id ) ) {
	...
	if ( isset( $point_log ) && is_array( $point_log ) && null != $point_log ) {
		...
		if ( array_key_exists( 'membership', $point_log ) ) {
			?>
			<div class="mwb_wpr_slide_toggle">
				<p class="mwb_wpr_view_log_notice mwb_wpr_common_slider"><?php esc_html_e( 'Points deducted as you have Entered to the membership level', 'points-rewards-for-woocommerce' ); ?><a class ="mwb_wpr_open_toggle"  href="javascript:;"></a></p>
				<a class ="mwb_wpr_open_toggle"  href="javascript:;"></a>
				<table class="mwb_wpr_common_table">
					<thead>
						<tr>
		...
		do_action( 'mwb_wpr_additional_points_tab', $point_log );
		?>
		<div class="mwb_wpr_slide_toggle">
