			...
			<?php if ( ! empty( $custom_action_icons ) ) : ?>
				...
				<?php if ( ! empty( $custom_action_font_icons ) ) : ?>
					...
					if ( Framework\SV_WC_Plugin_Compatibility::is_wc_version_lt( '3.3' ) ) {
						...
						$target_classes       = implode( ', .wc-action-button.wc-action-button-', array_keys( $custom_action_icons ) );
						$target_classes_after = implode( ':after, .wc-action-button.wc-action-button-', array_keys( $custom_action_icons ) );
					}
