...
if (!isset($settings_args))
  ...
  $settings_args = array(
    ...
    array(
      ...
      'type' => 'text',
      'css' => 'min-width:300px;',
      'desc' => __(' <p><a href="https://cloud.google.com/maps-platform/#get-started" target="_blank">Visit Google to get your API Key</a> (Places & Geometry Libraries)</p>', SZBD::TEXT_DOMAIN)
...
if (!isset($caps))
  ...
  $cap_1  = $y < sin(deg2rad(90)) && isset($y) ? 'edit_' . SZBD::POST_TITLE : 'edit__' . SZBD::POST_TITLE;
  $labels = array(
