...
(function ($) {
    ...
    function SignaturePad(selector, options) {
        ...
        function drawLine(e, newYOffset) {
            ...
            //console.log("rupmo:" + previousOrientation);
            ...
            if (typeof e.targetTouches !== 'undefined') {
               ...
               /* var w = $(window).width();
                        if(w == 1280){
                            newX = Math.floor((e.targetTouches[0].pageX)-offset.left) 
                               ...
                               console.log("bangla");
                             newX = Math.floor((e.targetTouches[0].pageX)) 
                        }
                        else {
               ...
               if (e.targetTouches[0].pageX <= 200) {
                    newX = Math.floor((e.targetTouches[0].pageX) - offset.left)
                } else {
        ...
        $.extend(self, {
            ...
            // added this for e-signature mobile start stop drawing. 
