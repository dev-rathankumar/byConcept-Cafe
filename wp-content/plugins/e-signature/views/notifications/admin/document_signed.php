...
<div id=":zs" class="ii gt m1436f203bed358e3 adP adO">
  <div id=":zr" style="overflow: hidden;">
    ...
    <div style="background-color:#efefef;margin:0;padding:0;font-family:'HelveticaNeue',Arial,Helvetica,sans-serif;font-size:14px;line-height:1.4em;width:100%;max-width:600px;margin: 0 auto;">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">  <tbody>  <tr style="border-collapse:collapse"> 
...
<tr style="border-collapse:collapse">
    <td style="font-family:'HelveticaNeue',Arial,Helvetica,sans-serif;font-size:14px;line-height:1.4em;border-collapse:collapse" align="left" width="100%">                       
            <div style="margin:0 0 20px 0">                       
                        <?php  $logo_alignment= apply_filters('esig-logo-alignment','',esigget('wpUserId', $data)); 
       ...
       <p  <?php echo $logo_alignment;  ?>> 
         ...
         <table width="100%">                         
                <tbody><tr> <td style="background-color:#f7fafc;padding:8px 10px;border:1px solid #ccc;color:#444;font-weight:bold;margin-bottom:10px;text-align:center" bgcolor="#F7FAFC"><?php echo $data['signer_name']; ?> <?php _e('has signed your document','esig'); ?> </td>  </tr></tbody> </table>
                <table width="100%" style="width: 100%;border-collapse: collapse; "><tbody><tr><td style="background-color:#ffffff;border:1px solid #ccc;padding:15px" bgcolor="FFFFFF"><h1 style="font-size:18px;margin:0 0 10px 0;font-weight:bold"><?php _e('Document Name:','esig'); ?><?php echo $data['document_title']; ?></h1><?php _e('Document ID:', 'esig' );?> (<?php echo $data['document_checksum']; ?>)<p style="line-height:1.4em;font-size:14px;margin:10px 0px"> <span style="color:#8c8c8c"><?php _e('From:','esig');?> <?php echo $data['sender']; ?> (<a href="mailto:<?php echo $data['owner_email']; ?>" target="_blank"><?php echo $data['owner_email']; ?></a>) </span> </p><hr style="color:#cccccc;background-color:#cccccc;min-height:1px;border:none"><p style="line-height:1.4em;font-size:14px;margin:10px 0px">Hi <?php echo $data['owner_first_name']; ?>,<br><?php   $custom_message = apply_filters('esig_admin_confirmation_custom_message','',$document_checksum=$data['document_checksum']);  echo $custom_message; ?><br>  <?php echo $data['signer_name']; ?> (<?php echo $data['signer_email']; ?>) <?php _e('has signed your document.','esig'); ?><br><?php if(!empty($data['document_id'])){  _e(' Audit Trail Serial#:','esig');?> <?php echo $data['document_id'];  } ?>  </p><hr style="color:#cccccc;background-color:#cccccc;min-height:1px;border:none"><div style="margin:20px 0px 20px 0px">
