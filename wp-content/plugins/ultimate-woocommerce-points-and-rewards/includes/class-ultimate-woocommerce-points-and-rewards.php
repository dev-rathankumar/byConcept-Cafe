...
class Ultimate_Woocommerce_Points_And_Rewards {
	...
	private function define_admin_hooks() {
		...
		if ( self::$callname_lic() || 0 <= $day_count ) {
			...
			$this->loader->add_filter( 'mwb_coupon_tab_text', $plugin_admin, 'mwb_wpr_change_the_coupon_tab_text' );
			$this->loader->add_filter( 'mwb_add_coupon_details', $plugin_admin, 'mwb_wpr_add_coupon_details', 10, 2 );
			$this->loader->add_action( 'mwb_wpr_add_additional_import_points', $plugin_admin, 'mwb_wpr_add_additional_import_points', 10 );
			$this->loader->add_action( 'mwb_wpr_additional_general_settings', $plugin_admin, 'mwb_wpr_additional_cart_points_settings', 10, 2 );
		}
