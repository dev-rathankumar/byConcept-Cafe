	...
	array(
		...
		'number_text' => array(
			array(
				...
				'custom_attributes' => array( 'min' => '"1"' ),
				'desc_tip' => __(
					'Set the Time-Period for "When the points needs to get expired?" It will calculated over the above Threshold Time',
...
?>
	...
	<div class="clear"></div>
	<p class="submit">
		<input type="submit" value='<?php esc_html_e( 'Save changes', 'ultimate-woocommerce-points-and-rewards' ); ?>' class="button-primary woocommerce-save-button mwb_wpr_save_changes" name="mwb_wpr_save_point_expiration">
	</p>
