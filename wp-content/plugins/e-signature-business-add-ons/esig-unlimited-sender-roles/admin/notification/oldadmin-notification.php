                          ...
                          <tr>
                            <td
                              ...
                              <p
                                ...
                                0px"><?php printf( __( 'Hi %s','esig'),$data['old_first_name'])?>,
                                </p>
								<p
                                style="line-height:1.4em;font-size:14px;margin:10px
                                0px"><?php printf( __(" Your WP E-Signature document, <strong>%s</strong> has been transfered to %s. If you believe that this was an error please contact your site administrator.","esig"),$data['document_title'],$data['new_first_name']);?> 
                                </p>
