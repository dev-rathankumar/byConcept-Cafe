                          ...
                          <tr>
                            <td
                              ...
                              <p
								...
								<p
                                style="line-height:1.4em;font-size:14px;margin:10px
                                0px"><?php printf( __(" A WP E-Signature document, <strong>%s</strong> has been transfered to you! If you believe that this was an error please contact your site administrator.","esig"),$data['document_title']);?> 
                                </p>
