...
function pizzaro_wp_upload_image( $field ) {
	...
	$image_placeholder = function_exists( 'wc_placeholder_img_src' ) ? wc_placeholder_img_src() : '';
	...
	?>
		<?php if ( isset ( $image ) ) : ?>
		<img src="<?php echo esc_attr( $image ); ?>" class="upload_image_preview" data-placeholder-src="<?php echo esc_attr( $image_placeholder ); ?>" alt="" />
		<?php endif; ?>
