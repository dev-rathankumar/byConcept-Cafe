...
function auxin_get_available_post_types_for_search() {
    $post_types = array(
        'post' => __( 'Post', 'phlox-pro' ),
        'page' => __( 'Page', 'phlox-pro' )
    );

    if ( class_exists('WooCommerce') ) {
        $post_types['product'] = __( 'Product', 'phlox-pro' );
    }

    if ( class_exists('AUXPFO') ) {
        $post_types['portfolio'] = __( 'Portfolio', 'phlox-pro' );
    }

    if ( class_exists('AUXNEW') ) {
        $post_types['news'] = __( 'News', 'phlox-pro' );
    }

    if ( class_exists( 'AUXPRO' )) {
        $post_types['faq'] = __( 'FAQ', 'phlox-pro' );
    }
