...
$hero_bg_img 	= $theme_path . '/hero-customer-invoice.png';
														...
														<tr>
															<td align="center" class="bg-000000 btn block">
																<?php if ( $order->has_status( 'pending' ) ) : ?>
																	<a href="<?php echo $order->get_checkout_payment_url(); ?>" class="font-btn font-primary font-14 font-weight-600 font-space-1 block">
																	<?php printf(  __( 'Pay Now', 'woocommerce' ) ); ?>
																	</a>
																<?php else : ?>
																	<a href="<?php echo $order->get_view_order_url(); ?>" class="font-btn font-primary font-14 font-weight-600 font-space-1 block">
																	<?php printf(  __( 'View Order', 'woocommerce' ) ); ?>
																<?php endif; ?>
															</td>
														</tr>
													</table>
							...
							<tr>
								<td align="center">
									...
									<table cellpadding="0" cellspacing="0" align="center" width="100%">
										<tr>
											<td align="center" class="font-000000 font-primary font-32 font-weight-600 font-space-2 pb-20">
												<?php printf(  __( 'Your Order is Pending', 'woocommerce' ) ); ?>
											</td>
										</tr>
										<tr>
									...
									<table cellpadding="0" cellspacing="0" align="center" width="100%">
										<tr>
											<td align="center" class="font-000000 font-primary font-32 font-weight-600 font-space-2 pb-20">
												<?php printf(  __( 'Order Details', 'woocommerce' ) ); ?>
											</td>
										</tr>
										<tr>
											<td align="center" class="font-777777 font-primary font-18 font-weight-400 font-space-2 pb-40">
