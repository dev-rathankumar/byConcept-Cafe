...
$hero_bg_img 	= $theme_path . '/hero-customer-refunded-order.png';
													...
													<table cellspacing="0" cellpadding="0" align="left" class="mo-btn-full mo-center">
														<tr>
															<td align="center" class="bg-000000 btn block">
																<a href="<?php echo get_home_url(); ?>" class="font-btn font-primary font-14 font-weight-600 font-space-1 block">
																<?php printf(  __( 'Contact Us', 'woocommerce' ) ); ?>
																</a>
															</td>
														</tr>
													</table>
									...
									<table cellpadding="0" cellspacing="0" align="center" width="100%">
										<tr>
											<td align="center" class="font-000000 font-primary font-32 font-weight-600 font-space-2 pb-20">
												<?php printf(  __( 'Refund Status', 'woocommerce' ) ); ?>
											</td>
										</tr>
										<tr>
											<td align="center" class="font-777777 font-primary font-18 font-weight-400 font-space-2 pb-40">
												<?php 
													...
													if ( $partial_refund ) {
														printf( __( ' partially refunded.', 'woocommerce' ), get_option( 'blogname' ) );
													} else {
														printf( __( ' refunded.', 'woocommerce' ), get_option( 'blogname' ) );
													}
												?>
											</td>
										</tr>
